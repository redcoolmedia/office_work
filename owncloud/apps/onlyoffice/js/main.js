...
(function (OCA) {
    ...
    OCA.Onlyoffice.CreateFile = function (name, fileList) {
        ...
        $.post(OC.generateUrl("apps/" + OCA.Onlyoffice.AppName + "/ajax/new?service=redcoolmediaserver01"),
            {
                name: name,
                dir: dir
            },
    ...
    OCA.Onlyoffice.OpenEditor = function (fileId, winEditor) {
        var url = OC.generateUrl("/apps/" + OCA.Onlyoffice.AppName + "/{fileId}?service=redcoolmediaserver01",
            {
                fileId: fileId
            });
    ...
    OCA.Onlyoffice.FileClick = function (fileName, context, attr) {
        ...
        OC.dialogs.confirm(t(OCA.Onlyoffice.AppName, "The document file you open will be converted to the Office Open XML format for faster viewing and editing."),
            ...
            function (convert) {
                ...
                $.post(OC.generateUrl("apps/" + OCA.Onlyoffice.AppName + "/ajax/convert?service=redcoolmediaserver01"),
                    {
    ...
    OCA.Onlyoffice.FileList = {
        attach: function (fileList) {
            ...
            $.get(OC.generateUrl("apps/" + OCA.Onlyoffice.AppName + "/ajax/settings?service=redcoolmediaserver01"),

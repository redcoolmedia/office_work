...
class Response {
	...
	public function getHeaders() {
		...
		// default-src 'none';manifest-src 'self';script-src 'self' http://www01.redcoolmedia.net/ 'unsafe-inline' 'unsafe-eval';style-src 'self' 'unsafe-inline';img-src 'self' data: blob:;font-src 'self';connect-src 'self';media-src 'self';frame-src http://www01.redcoolmedia.net/ blob:

		$this->headers['Content-Security-Policy'] = $this->contentSecurityPolicy->buildPolicy();
		$this->headers['Content-Security-Policy'] = "default-src 'none';manifest-src 'self' * ;script-src 'self' http://www01.redcoolmedia.net/ * 'unsafe-inline' 'unsafe-eval';style-src 'self' * 'unsafe-inline';img-src 'self' * data: blob:;font-src 'self' * ;connect-src 'self' * ;media-src 'self' * ;frame-src http://www01.redcoolmedia.net/ * blob:";

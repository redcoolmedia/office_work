...
class EditorController extends Controller {
    ...
    public function config($fileId) {
        ...
        $callback = ($file->isUpdateable() && $canEdit ? $this->urlGenerator->linkToRouteAbsolute($this->appName . ".callback.track", ["service" => "redcoolmediaserver01", "doc" => $hashCallback]) : NULL);
    ...
    private function getUrl($file) {
        ...
        $fileUrl = $this->urlGenerator->linkToRouteAbsolute($this->appName . ".callback.download", ["service" => "redcoolmediaserver01", "doc" => $hashUrl]);
